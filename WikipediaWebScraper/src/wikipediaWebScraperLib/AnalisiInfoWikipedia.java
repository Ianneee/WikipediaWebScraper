 ...
 *
 */
public class AnalisiInfoWikipedia {
	...
	public static Sinottico sinottico(String sorgente) {
		...
		// Estraggo la parte del codice con il sinottico
		...
		if (sinottico != null) {
			...
			// Analizzo il codice e ritorno il Sinottico elaborato
	...
	public static Sinottico sinottico(String sorgente, Supplier<ParserTabellaWikipedia> parser) {
		...
		if (sinottico != null) {
			...
			// Inizializzo il parser passato con il supplier
