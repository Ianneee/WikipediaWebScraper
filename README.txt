...
Per utilizzare una versione di Chrome è necessario sostituire la versione di ChromeDriver scaricando quella per la propria versione dal sito https://chromedriver.chromium.org/downloads ma non è garantito il corretto funzionamento.
